...
| 기능 | 설명 |
|------|------|
| 히어로 섹션 | 카피, 동아리 소개, 운영 기간 |
| 사례 카드 | 비전공자 성공 사례 3건 (스크린샷/GIF + 카드 UI) |
| 커리큘럼 타임라인 | 4단계 스텝 시각화 |
| FAQ 아코디언 | 6개 질문/답변 토글 |
| 소개 마무리 | 동아리 성격 요약, 운영 기간 안내 |
...
| 규칙 | 상세 |
|------|------|
| 대상 | 김해 거주·직장·학교 재학 19~45세 청년 (텍스트로만 안내) |
| 페이지 성격 | 동아리 소개/가이드 페이지. 신청 폼이나 외부 링크 없음 |
...
"AI-아이가 어떤 동아리인지" 파악하고, "여기서 자유롭게 AI를 탐색하고 서로 나눌 수 있겠다"는 기대를 갖게 한다.

- PPT 발표 자료 대용으로 활용 가능한 접근성 높은 웹 페이지
- 페이지 자체가 "바이브 코딩으로 만들었다"는 메타 메시지 전달
- 운영자 주도 교육이 아닌, 자율 탐색 + 공유/토론/피드백 커뮤니티 톤
