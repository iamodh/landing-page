...
- [ ] 동아리명, 운영 기간(2026년 4월 ~ 12월) 텍스트 노출
...
- [ ] "이 페이지도 AI로 만들었습니다" 메타 메시지 노출

**완료 조건:** 이미지 파일 없는 상태에서 레이아웃 정상

- Commits:
  - `feat: ShowcaseSection with placeholders`
...
- [ ] 4단계 모두 렌더링 (1단계~4단계)
- [ ] 각 단계에 기간, 제목, 설명 표시
- [ ] 375px에서 타임라인 레이아웃 깨짐 없음

**완료 조건:** 모바일에서 4단계 타임라인 스크롤 없이 파악 가능

- Commits:
  - `feat: CurriculumSection timeline`
...
- [ ] 항목 클릭 시 답변 열림/닫힘 **(P0)**
- [ ] 동시에 두 개 열리지 않음 **(P0)**
- [ ] 375px에서 긴 답변 텍스트 잘림 없음

**완료 조건:** 모바일에서 FAQ 6개 토글 동작 확인

- Commits:
  - `feat: FaqSection with accordion`
